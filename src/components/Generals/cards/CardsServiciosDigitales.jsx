...
import qrServicio from '../../../assets/qr.png'
const CardsServiciosDigitales = () => {
  const settings = {
    dots: false,
    infinite: true,
    speed: 500,
    ...
    <div className="slider-container">
      ...
      <Link to={'/SolucionesDigitalesPage'} className='card2'>
        <img src={ecommerceServicio} alt="" />
                ...
                <img src={desarrolloWebServicio} alt="" />
                    <div className='content contentFlex'>
         ...
         <img src={aplicacionesWebServicio} alt="" />
                    <div className='content contentFlex'>
                ...
                <Link to={"/MantenimientoPage"} className='card2'>
         <img src={migracionalaNubeServicio} alt="" />
                    <div className='content contentFlex'>
                        <h3 className='cardsComponentesTitulos'>Mantenimiento</h3>
...
export default CardsServiciosDigitales;
