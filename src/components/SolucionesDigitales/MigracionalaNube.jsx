...
<a className='whatsapp'  href="https://wa.me/"><img src={whatsapp} alt="" /></a>
      ...
      <div className='homePrimerCompContainerImg h-100 imagenlatidoContainer flex-align-center flex-justify-center  '>
        <img className='wd-100 h-90  homePrimerCompImg imagen-latido' src={migracionalaNubeServicio} alt="" />
      </div>
      ...
      <div className='wd-100 '>
        ...
        <div className=' containerHeight '>
          ...
          <div className=' impulsaTuMarcaContainerImg'>
            <img className='wd-100' src={migracionalaNubeServicio} alt="imagen grafica pnp" /></div>
      ...
      <div className='wd-100 '>
        ...
        <div className=' containerTextoImgImpulsaTuMarca '>
          ...
          <div className=' impulsaTuMarcaContainerImg'>
            <img className='wd-100' src={migracionalaNubeServicio} alt="imagen grafica pnp" />
          </div>
...
export default MigracionalaNube